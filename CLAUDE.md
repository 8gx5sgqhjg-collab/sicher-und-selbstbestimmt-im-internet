...
8. **Prüfgruppen-Katalog (offen):** Menü-Wörter („Mein Lernweg"), Lautsprecher-Symbol ohne Wort, Formel „eine Person, der du vertraust", Themen-Gruppen-Namen, Frage des Tages, KI-Einsamkeits-Satz, Frage-Muster-Sätze, QR-Karten, „Lernen starten"-Knopf, Leitsatz „So lernst du." mit den Stations-Wörtern „Merken" / „Prüfen" / „Handeln" (🧠 ✅ ➜, Station 0), „DEINE eine Sache für heute" (Station 5 — live heute als „Eine Sache für heute", app.js:4654/:4723), Stations-Etikett 🧠 Merken / ✅ Prüfen / ➜ Handeln im Themenfluss (Stationen 3–5), Liste „Prüfe dich selbst:" im Quiz-Ergebnis (Station 4), Knopf „Hilfe nochmal lesen" (Station 5, sensible Themen), Wegzeichen-Figuren v2 (winken/themen/lernweg/einstellungen/ruhig — transparent, statisch) — erkennt die Person die Seiten an den Figuren wieder? Passt die Rolle zur Figur? Sind die Haltungen eindeutig? Wo stören sie? (Konzept „Wegzeichen", 09.09.2026), First-Run-Etikette: „Mehr über dieses Angebot" (einklappte Angebots-Liste auf #start), „Fang hier an" (erste Kachel, erster Besuch), „Das Menü unten ist immer da." (Chip), Screen-Titel „Wer lernt heute?" (Paket F, 09.09.2026).
