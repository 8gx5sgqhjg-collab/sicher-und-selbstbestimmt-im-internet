...
| 10 | `blockRead` doppelt (global + lokale Kopie in `renderLesson`) | `app.js:4075`, `:4163` | ✓ bekannt; der Code-Kommentar nennt die Zusammenführung selbst als „späteren Schritt“ | **zurückgestellt** — Aufräumen (Stufe 5) |
| 11 | Toter Code: `getIllustrationHtml()` (0 Aufrufer), `collectReadableText()` (ungenutzt laut Kommentar) | `app.js:963`, `:1378` | ✓ bestätigt | **zurückgestellt** — Aufräumen (Stufe 5) |
